--------------------------------------------------
-- PLACE CHECK (GIỮ NGUYÊN)
--------------------------------------------------
if game.PlaceId ~= 10449761463 then
	warn("❌ The script only works in The-Strongest-Battlegrounds")
	return
end
...
accept.TextSize = 30
accept.BackgroundColor3 = Color3.fromRGB(0,160,200)
...
titleText.Text = "Thinne Hub - Main Menu"
